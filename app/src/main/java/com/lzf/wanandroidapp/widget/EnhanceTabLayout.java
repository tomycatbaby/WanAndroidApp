...
public class EnhanceTabLayout extends FrameLayout {
    ...
    private void readAttr(Context context, AttributeSet attrs) {
        ...
        mSelectIndicatorColor = typedArray.getColor(R.styleable.EnhanceTabLayout_tabIndicatorColor, Color.parseColor("#3975F6"));
        mUnSelectTextColor = typedArray.getColor(R.styleable.EnhanceTabLayout_tabTextColor, Color.parseColor("#666666"));
        mSelectTextColor = typedArray.getColor(R.styleable.EnhanceTabLayout_tabSelectTextColor, Color.parseColor("#000000"));
